        ...
        <Router>
          ...
          <div className="Kassa">
            <Routes>
              ...
              <Route path="/Tisch1" id="relement" element={<Table1 />} />
              <Route path="/Tisch2" id="relement" element={<Table2 />} />
              <Route path="/Tisch3" id="relement" element={<Table3 />} />
              <Route path="/Tisch4" id="relement" element={<Table4 />} />
              <Route path="/Tisch5" id="relement" element={<Table5 />} />
              <Route path="/Tisch6" id="relement" element={<Table6 />} />
              <Route path="/Tisch7" id="relement" element={<Table7 />} />
              <Route path="/Tisch8" id="relement" element={<Table8 />} />
              <Route path="/Tisch9" id="relement" element={<Table9 />} />
              <Route path="/Tisch10" id="relement" element={<Table10 />} />
